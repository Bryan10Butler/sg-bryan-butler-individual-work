...
public class DvdView {
    ...
    public Dvd getNewDvdInfo() {
        ...
        LocalDate releaseDate = io.readLocalDate("Please enter the DVD Release Data");
    ...
    public void displayDvd(Dvd dvd) {
        if (dvd != null) {
            ...
            io.print(dvd.getLocalDateReleaseDate().toString());
    ...
    public void printMenuEditSelection(Dvd dvd) throws DvdPersistenceException {
        ...
        while (exitEditMenu) {
            ...
            switch (editMenuSelection) {
                ...
                case 4:
                    if (dvd != null) {
                        LocalDate releaseDate= io.readLocalDate("Set new Release Date: " + dvd.getLocalDateReleaseDate());
                        dvd.setLocalDateReleaseDate(releaseDate);
                        break;
                    }
                case 5:
                    if (dvd != null) {
