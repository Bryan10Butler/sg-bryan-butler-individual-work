...
public class DvdDaoFileImpl implements DvdDao {
    ...
    @Override
    public void loadCollection() throws DvdPersistenceException {
        Scanner scanner;
        ...
        while (scanner.hasNextLine()) {
            ...
            Dvd dvdObject = new Dvd(currentTokens[0], LocalDate.parse(currentTokens[3]), currentTokens [2], currentTokens [1], currentTokens [4], currentTokens [5]);
            // Set the remaining values on currentStudent manually

            // Put currentStudent into the map using studentID as the key
            dvdMap.put(dvdObject.getTitle(), dvdObject);
        }
        // close scanner
        scanner.close();
    }
    ...
    @Override
    public void writeCollection() throws DvdPersistenceException {
        ...
        for (Dvd currentStudent : studentList) {
            ...
            out.println(currentStudent.getTitle() + DELIMITER
                    ...
                    + currentStudent.getLocalDateReleaseDate() + DELIMITER
