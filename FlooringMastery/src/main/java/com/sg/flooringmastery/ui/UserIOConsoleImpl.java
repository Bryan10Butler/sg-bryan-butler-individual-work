...
public class UserIOConsoleImpl implements UserIO{
    ...
    public double readDouble(String prompt, double min, double max) {
        ...
        do {
            ...
            if (number < min || number > max) {
                print("Please input a selection between " + min + " and " + max);
                invalidInput = true;
            }else {
                invalidInput = false;
            }// end of else
    ...
    public int readInt(String prompt, int min, int max) {
        ...
        do {
            ...
            number = Integer.parseInt(numberString);
            if (number < min || number > max) {
                print("Please provide a number between " + min + " and " + max + " inclusive");
                invalidInput = true;
            }else {
                invalidInput = false;
            }// end of else
    ...
    public BigDecimal readBigDecimal(String prompt) {
        ...
        do {
            try {
                //display the prompt
                print(prompt);
                String bigDecimalString = inputReader.nextLine();
                //convert to BD by instantiating new BD
        ...
        //returning BigDecimal as string - WHY
        return number;
    }
    ...
    public LocalDate readLocalDate(String prompt) {
        ...
        while (invalidInput){
            try {
                ...
                userDate = LocalDate.parse(userString, DateTimeFormatter.ofPattern("MMddyyyy"));
                invalidInput = false;

            } catch (DateTimeParseException e) {
                //print("Please enter a valid date format MMDDYYYY");
                invalidInput = true;
            }
        }
        return userDate;
