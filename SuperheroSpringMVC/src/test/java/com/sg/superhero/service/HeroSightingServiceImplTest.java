...
public class HeroSightingServiceImplTest {
    ...
    public void removeHeroSighting() {
        ...
        HeroSighting readHeroSighting = heroSightingService.retrieveHeroSightingById(heroSighting.getHeroSightingId());
    ...
    public void updateHeroSighting() {
        ...
        //Act
        heroSightingService.updateHeroSighting(heroSighting);
    ...
    public void retrieveHeroSightingBySighting() {
        ...
        //Act
        List<HeroSighting> readHeroSighting = heroSightingService.retrieveHeroSightingBySighting(createdSighting.getSightingId());
    ...
    public void retrieveHeroSightingByHero() {
        ...
        //Act
        List<HeroSighting> readHeroSighting = heroSightingService.retrieveHeroSightingByHero(createdHero.getHeroId());
