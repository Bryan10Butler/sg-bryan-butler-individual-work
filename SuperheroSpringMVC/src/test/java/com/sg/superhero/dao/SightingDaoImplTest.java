...
public class SightingDaoImplTest {
    ...
    public void removeSighting() {
        ...
        Sighting readSighting = sightingDao.retrieveSighting(sighting.getSightingId());
    ...
    public void updateSighting() {
        ...
        //Assert
        Sighting updatedSighting = sightingDao.retrieveSighting(sighting.getSightingId());
    ...
    public void retrieveAllSightings() {
        ...
        Sighting readingSighting = sightingDao.retrieveSighting(sightingTwo.getSightingId());

        //Update Fields
        readingSighting.setDate((LocalDate.parse("2018-04-06", DateTimeFormatter.ISO_DATE)));
        readingSighting.setDescription("Hulk Smash!");

        sightingDao.updateSighting(readingSighting);
    ...
    public void retrieveSightingByHero() {
        ...
        //Act
        List<Sighting> sightingList = sightingDao.retrieveSightingByHero(createdHero, Integer.MAX_VALUE, 0);
    ...
    public void retrieveSightingByHeroPage() {
        ...
        //Act
        List<Sighting> sightingList = sightingDao.retrieveSightingByHero(createdHero, 1, 0);
    ...
    public void retrieveSightingByLocation() {
        ...
        //Act
        List <Sighting> sightingList = sightingDao.retrieveSightingByLocation(createdLocation, Integer.MAX_VALUE, 0);
    ...
    public void retrieveSightingByLocationPage() {
        ...
        //Act
        List <Sighting> sightingList = sightingDao.retrieveSightingByLocation(createdLocation, 1, 0);
    ...
    public void retrieveSightingByDate() {
        ...
        //Act
        List <Sighting> sightingList = sightingDao.retrieveSightingByDate(LocalDate.parse("2019-04-04", DateTimeFormatter.ISO_DATE), Integer.MAX_VALUE, 0);
    ...
    public void retrieveSightingByDatePage() {
        ...
        //Act
        List <Sighting> sightingList = sightingDao.retrieveSightingByDate(LocalDate.parse("2019-04-04", DateTimeFormatter.ISO_DATE), 1, 0);
