...
public class HeroDaoImplTest {
    ...
    public void removeHero() {
        ...
        //Act
        heroDao.removeHero(createdHero);

        //Assert
        Hero readHero = heroDao.retrieveHero(createdHero.getHeroId());
        assertNull(readHero);
    }
    ...
    public void updateHero() {
        ...
        //Act
        heroDao.updateHero(readHero);

        //Assert
        Hero updatedHero = heroDao.retrieveHero(readHero.getHeroId());
    ...
    public void retrieveAllHero() {
        ...
        Hero readHero = heroDao.retrieveHero(createdHeroTwo.getHeroId());
        ...
        assertEquals(2, heroDao.retrieveAllHero(Integer.MAX_VALUE, 0).size());
    }
    ...
    public void retrieveHeroByPower() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroByPower(createdPower, Integer.MAX_VALUE, 0);
    ...
    public void retrieveHeroByPowerPage() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroByPower(createdPower, 1, 0);

        //Assert
        //Page even though we created two hero's we paginate 1
        assertHeroesByPower(numberOfHeroes, heroList, createdPower);
    }
    ...
    public void retrieveHeroBySighting() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroBySighting(createdSighting, Integer.MAX_VALUE, 0);
    ...
    public void retrieveHeroBySightingPage() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroBySighting(createdSighting, 1, 0);
    ...
    public void retrieveHeroByOrganization() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroByOrganization(createdOrganization, Integer.MAX_VALUE, 0);
    ...
    public void retrieveHeroByOrganizationPage() {
        ...
        //Act
        List<Hero> heroList = heroDao.retrieveHeroByOrganization(createdOrganization, 1, 0);
    ...
    private void assertHeroesBySighting(int numberOfHeroes, List<Hero> heroList, Sighting sighting) {
        ...
        for (Hero hero : heroList) {
            ...
            for (Sighting sight : heroSightings) {
                //make sure the sighting we added is contained in the list
