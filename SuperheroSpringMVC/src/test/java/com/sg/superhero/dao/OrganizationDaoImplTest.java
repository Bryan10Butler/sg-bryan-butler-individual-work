...
public class OrganizationDaoImplTest {
    ...
    public void removeOrganization() {
        ...
        Organization readOrganization = organizationDao.retrieveOrganization(organization.getOrganizationId());
    ...
    public void updateOrganization() {
        ...
        //Assert
        Organization updatedOrganization = organizationDao.retrieveOrganization(organization.getOrganizationId());
        assertEquals("Suicide Squad", updatedOrganization.getName());
        assertEquals("Crazy People", updatedOrganization.getDescription());
        assertEquals(organization.getLocation().getLocationId(), updatedOrganization.getLocation().getLocationId());
    ...
    public void retrieveAllOrganizations() {
        ...
        Organization readOrganization = organizationDao.retrieveOrganization(organizationTwo.getOrganizationId());
        ...
        //Act and Assert
        assertNotEquals(organization.getOrganizationId(), readOrganization.getOrganizationId());
        assertEquals(2,organizationDao.retrieveAllOrganizations(Integer.MAX_VALUE, 0).size());
    }
    ...
    public void retrieveOrganizationByHero() {
        ...
        //Act
        List<Organization> organizationList = organizationDao.retrieveOrganizationByHero(createdHero, Integer.MAX_VALUE, 0);
    ...
    public void retrieveOrganizationByHeroPage() {
        ...
        //Act
        List<Organization> organizationList = organizationDao.retrieveOrganizationByHero(createdHero, 1, 0);
