...
@Rollback
@Transactional
public class HeroOrganizationDaoImplTest {
    ...
    public void removeHeroOrganization() {
        ...
        HeroOrganization readHeroOrganization = heroOrganizationDao.retrieveHeroOrganizationById(heroOrganization.getHeroOrganizationId());
    ...
    public void retrieveHeroOrganizationByOrganization() {
        ...
        //Act
        List<HeroOrganization> readHeroOrganization = heroOrganizationDao.retrieveHeroOrganizationByOrganization(createdOrganization.getOrganizationId());
    ...
    public void retrieveHeroOrganizationByHero() {
        ...
        //Act
        List<HeroOrganization> readHeroOrganization = heroOrganizationDao.retrieveHeroOrganizationByHero(createdHero.getHeroId());
    ...
    private HeroOrganization createdHeroOrganization(Hero createdHero, Organization createdOrganization) {
        ...
        heroOrganizationDao.addHeroOrganization(heroOrganization);
