...
@Rollback
@Transactional
public class HeroPowerDaoImplTest {
    ...
    public void removeHeroPower() {
        ...
        HeroPower readPower = heroPowerDao.retrieveHeroPowerById(heroPower.getHeroPowerId());
...
//        createdPowerTwo.setDescription("Hero is very strong");
        ...
        //Assert
        HeroPower readHeroPower = heroPowerDao.retrieveHeroPowerById(heroPower.getHeroPowerId());
    ...
    public void retrieveHeroPowerByPower() {
        ...
        //Act
        List<HeroPower> readHeroPowers = heroPowerDao.retrieveHeroPowerByPower(createdPower.getPowerId());
    ...
    public void retrieveHeroPowerByHero() {
        ...
        //Act
        List<HeroPower> readHeroPowers = heroPowerDao.retrieveHeroPowerByHero(createdHero.getHeroId());
    ...
    private HeroPower createHeroPower(Hero createdHero, Power createdPower) {
        ...
        heroPowerDao.addHeroPower(heroPower);
