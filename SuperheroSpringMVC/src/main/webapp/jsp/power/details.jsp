...
<div class="container">
    ...
    <div class="navbar">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="${pageContext.request.contextPath}/power/homepage">Power</a></li>
    ...
    <h4>Description:</h4> ${viewModel.description} <br /><br />

    <a href="/power/homepage"><button class="btn btn-default">Return</button></a>
