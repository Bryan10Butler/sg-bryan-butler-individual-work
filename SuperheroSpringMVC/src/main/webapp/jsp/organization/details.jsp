...
<div class="container">
    ...
    <div class="navbar">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a href="${pageContext.request.contextPath}/hero/homepage">Hero</a>
            </li>
    ...
    <h4>Location:</h4> ${viewModel.locationName} <br /><br />

    <a href="/organization/homepage"><button class="btn btn-default">Return</button></a>
</div>
</body>
</html>
