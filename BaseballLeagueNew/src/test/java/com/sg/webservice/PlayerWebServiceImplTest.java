...
public class PlayerWebServiceImplTest {
    ...
    public void getPlayerListViewModel() {
        ...
        //verify we are o the right page number
        ...
        for (PlayerViewModel playerViewModel: playerListViewModel.getPlayers()) {
            ...
            //so test will pass even if in the future it becomes not lazy loaded
    ...
    public void saveCreatePlayerCommandModel(){
        ...
        //Instantiate the commend model
        //In the we side of things spring is going to handle this part for us.
