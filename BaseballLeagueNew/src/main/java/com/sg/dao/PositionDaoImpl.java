...
public class PositionDaoImpl implements PositionDao{
    ...
    public Position read(Long id) {
        ...
        try {
            return jdbcTemplate.queryForObject(Read_QUERY, new PositionMapper(), id);
    ...
    public List<Position> getPositionsByPlayer(Player player, int limit, int offset) {
        return jdbcTemplate.query(GET_POSITIONS_BY_PLAYER_QUERY, new PositionMapper(), player.getId(), limit, offset);
    }

    @Override
    public List<Position> list(int limit, int offset) {
        return jdbcTemplate.query(LIST_QUERY,
                new PositionMapper(),
                limit,
                offset);
    }
