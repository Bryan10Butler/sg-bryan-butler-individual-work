...
public class VendingMachineDaoFileImpl implements VendingMachineDao {
    ...
    private void loadVendingMachineItems() throws VendingMachinePersistenceException {
        ...
        try {
            ...
            scanner = new Scanner(new BufferedReader(new FileReader(vendingMachineItemsFile)));
        ...
        while (scanner.hasNextLine()) {
            ...
            VendingMachineItem vendingMachineCurrentItem = new VendingMachineItem(currentTokens[0]);
    ...
    private void writeVendingMachineItems() throws VendingMachinePersistenceException {
        ...
        try {
            out = new PrintWriter(new FileWriter(vendingMachineItemsFile));
        } catch (IOException e) {
            throw new VendingMachinePersistenceException(
