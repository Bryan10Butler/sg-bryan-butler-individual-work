...
-->
            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="email" class="form-control" name="email" id="add-email" placeholder="Email"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-phone" class="col-md-4 control-label">Phone:</label>
                        <div class="col-md-8">
                            <input type="tel" class="form-control" name="phone" id="add-phone" placeholder="Phone"/>
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <!--Place at the end of the document so that pages load faster-->
