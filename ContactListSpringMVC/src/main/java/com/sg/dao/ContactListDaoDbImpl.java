...
public class ContactListDaoDbImpl implements ContactListDao{
    ...
    public Contact addContact(Contact contact) {
        ...
        //same as insert in prepared statement
    ...
    //RowMapper - map a row into one of our contacts
    private static final class ContactMapper implements RowMapper<Contact> {

        //resultSet is object that contains object information from one row
        //int rowNum depending on how many rows we have
