...
public class LibraryDaoJdbcTemplateImpl implements LibraryDao{
    ...
    //create instance of jdbc to execute prepared statements against the database
    ...
    //prepared statements allow for CRUD for rows in database table
    //'?' act as placeholders for values supplied by user at runtime
    ...
    @Override
    //Use transactional as we have two transactions in the same method
    ...
    private static final class AuthorMapper implements RowMapper<Author> {
        ...
        @Override
        //Mapper converts row in database into a DTO Object
        //ResultSet rs is an object that contains information from row
        //Int i keeps track of what row we are working with
